    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/iced-americano.png" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Iced Americano</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Là loại cà phê truyền thống của người Mỹ với vị đắng nhẹ
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="23"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/rang-xay-3.webp" alt="Sản phẩm 1">
            ...
            <div class="related-product-item">
                <img src="image/iced-matcha-latte.png" alt="Sản phẩm 3">
