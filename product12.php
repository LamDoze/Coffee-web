    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-3.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Sữa Hòa Tan HIGHTLANDS</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Cà phê sữa hòa tan Highlands mang hương vị đậm đà, ngọt ngào và béo ngậy, kết hợp giữa cà phê rang xay đậm chất Việt Nam và vị sữa.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="13"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/can2.webp" alt="Sản phẩm 1">
                <p class="product-name">Cà phê lon Birdy</p>
                <p class="product-price">10.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/can3.webp" alt="Sản phẩm 2">
                <p class="product-name">Cà phê đen Nescafe</p>
                <p class="product-price">10.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/can4.webp" alt="Sản phẩm 3">
                <p class="product-name">Max Coffee</p>
