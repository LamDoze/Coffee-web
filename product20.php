    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/rang-xay-3.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Moka Buôn Mê Thuột</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            cà phê Moka Buôn Ma Thuột nổi bật với sự kết hợp giữa vị đắng nhẹ của cà phê và sự thanh thoát, ngọt ngào của hạt Moka
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="21"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/iced-matcha-latte.png" alt="Sản phẩm 1">
                <p class="product-name">Iced matcha latte</p>
                <p class="product-price">30.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/hoa-tan-4.webp" alt="Sản phẩm 2">
                <p class="product-name">Cà Phê Hòa Tan MACCOFFEE</p>
                <p class="product-price">25.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/hoa-tan-8.webp" alt="Sản phẩm 3">
                <p class="product-name">NesCafé Red Cup</p>
                <p class="product-price">70.000 VNĐ</p>
            </div>
        </div>
    </div>   
