    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-5.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Lion Café</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            cà phê nổi tiếng có nguồn gốc từ Hawaii, Mỹ có hương vị phong phú từ các loại hạt rang cẩn thận.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="15"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/hoa-tan-1.webp" alt="Sản phẩm 1">
                <p class="product-name">Cà Phê Trung Nguyên</p>
                <p class="product-price">25.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/iced-matcha-latte.png" alt="Sản phẩm 2">
                <p class="product-name">Iced Matcha Latte</p>
                <p class="product-price">230.000 VNĐ</p>
            </div>
            <div class="related-product-item">
