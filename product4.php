    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/iced-matcha-latte.png" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Iced Matcha Latte</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Thức uống có vị thơm đặc trưng từ bột trà xanh (thường là của Nhật Bản và Đài Loan), hòa quyện với vị sữa béo.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="25"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/can1.webp" alt="Sản phẩm 1">
                <p class="product-name">Cà Phê Sữa Đá</p>
                <p class="product-price">10.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/hoa-tan-6.webp" alt="Sản phẩm 2">
                <p class="product-name">Latte Almond</p>
                <p class="product-price">50.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/hoa-tan-7.webp" alt="Sản phẩm 3">
                <p class="product-name">Cà phê đen đá TCH</p>
                <p class="product-price">40.000 VNĐ</p>
            </div>
        </div>
    </div>   
