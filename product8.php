    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/can3.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Đen NESCAFE</h1>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="4"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/rang-xay-4.webp" alt="Sản phẩm 1">
                <p class="product-name">H'ren RobustaRobusta</p>
                <p class="product-price">100.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/rang-xay-1.webp" alt="Sản phẩm 2">
