    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/rang-xay-1.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Passion Coffee Phương Vy</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Passion Coffee Phương Vy có sự cân bằng hài hòa giữa vị đậm đà, chút đắng nhẹ và hậu vị ngọt.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="19"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/iced-americano.png" alt="Sản phẩm 1">
                <p class="product-name">Iced Americano</p>
                <p class="product-price">30.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/hoa-tan-1.webp" alt="Sản phẩm 2">
                <p class="product-name">Cà Phê Trung Nguyên</p>
                <p class="product-price">25.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/rang-xay-4.webp" alt="Sản phẩm 3">
                <p class="product-name">H'ren RobustaRobusta</p>
