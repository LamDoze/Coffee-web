...
<header>
    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-2.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Hòa Tan G7</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            G7 sử dụng công nghệ rang xay đặc biệt để giữ lại hương thơm tự nhiên và phong phú của cà phê.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="12"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            ...
            <div class="related-product-item">
                <img src="image/iced-americano.png" alt="Sản phẩm 2">
