    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/mocha-latte.jpg" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Mocha Latte</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Mocha Latte có hương vị nhẹ nhàng, mùi thơm của cà phê espresso và sữa tươi.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="24"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/hoa-tan-8.webp" alt="Sản phẩm 1">
            ...
            <div class="related-product-item">
                <img src="image/hoa-tan-2.webp" alt="Sản phẩm 3">
