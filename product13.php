    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-4.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Hòa Tan MACCOFFEE</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Cà phê hòa tan MacCoffee có hương vị nhẹ nhàng, dễ uống, thích hợp cho những người không thích cà phê quá đậm hay đắng.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="14"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/rang-xay-1.webp" alt="Sản phẩm 1">
                <p class="product-name">Passion Coffee Phương Vy</p>
                <p class="product-price">100.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/rang-xay-2.webp" alt="Sản phẩm 2">
                <p class="product-name">Trung Nguyên chế phin</p>
                <p class="product-price">60.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/rang-xay-3.webp" alt="Sản phẩm 3">
                <p class="product-name">Moka Buôn Mê Thuột</p>
                <p class="product-price">180.000 VNĐ</p>
            </div>
        </div>
    </div>   
