...
<header>
    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/can2.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Lon BIRDY</h1>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="2"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            ...
            <div class="related-product-item">
                <img src="image/hoa-tan-5.webp" alt="Sản phẩm 2">
                <p class="product-name">Lion Café</p>
                <p class="product-price">200.000 VNĐ</p>
            </div>
            <div class="related-product-item">
