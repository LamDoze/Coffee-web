    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/affogato.png" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Affogato</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Espresso thấm vào kem, làm tan chảy một phần kem, tạo nên sự hòa quyện mềm mịn giữa các tầng vị, mang đến trải nghiệm vừa sảng khoái, vừa ngọt ngào
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="26"> <!-- Thay 1 bằng ID thực của sản phẩm -->
