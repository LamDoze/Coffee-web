...
<header>
    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-7.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà phê đen đá TCH</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            cà phê đen đá của TCH có vị đậm đà và mạnh mẽ, đặc trưng của cà phê Việt Nam pha phin.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="17"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            ...
            <div class="related-product-item">
                <img src="image/affogato.png" alt="Sản phẩm 2">
                <p class="product-name">Affogato</p>
                <p class="product-price">30.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/mocha-latte.jpg" alt="Sản phẩm 3">
