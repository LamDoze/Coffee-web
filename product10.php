    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/hoa-tan-1.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">Cà Phê Trung Nguyên</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            Được làm từ các loại hạt cà phê Robusta và Arabica tuyển chọn kỹ lưỡng từ các vùng đất cao nguyên của Việt Nam.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="11"> <!-- Thay 1 bằng ID thực của sản phẩm -->
