    ...
    <div class="product-container">
        ...
        <div class="product-gallery">
            <div class="main-image">
                <img src="image/rang-xay-4.webp" alt="Product Image">
            </div>
        </div>
        ...
        <div class="product-details">
            ...
            <h1 class="product-title">H'ren RobustaRobusta</h1>
            <div class="product-rating">
                <span>★★★★★</span>
                <a href="#">Viết đánh giá</a>
            </div>
            <p class="product-description">
            cà phê H'ren Robusta mang đặc trưng của cà phê Robusta với vị đậm, mạnh mẽ và có một chút đắng gắt đặc trưng.
            </p>
            ...
            <div class="product-actions">
                <form action="admin/cart.php" method="POST">
                    <input type="hidden" name="product_id" value="22"> <!-- Thay 1 bằng ID thực của sản phẩm -->
    ...
    <div class="related-products">
        ...
        <div class="related-product-grid">
            <div class="related-product-item">
                <img src="image/mocha-latte.jpg" alt="Sản phẩm 1">
                <p class="product-name">Mocha Latte</p>
                <p class="product-price">30.000 VNĐ</p>
            </div>
            <div class="related-product-item">
                <img src="image/rang-xay-3.webp" alt="Sản phẩm 2">
                <p class="product-name">Moka buôn ma thuột</p>
